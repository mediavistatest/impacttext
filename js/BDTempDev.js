        ...
        Methods : {
            ...
            SendMessage : function(controllerParent, messageToSendArray, changeToStatus, callback, broadcastOutside) {
                ...
                for (var j = 0; j < messageToSendArray.length; j++) {
                    ...
                    var continueFunction = function(controllerParent) {
    ...
    Autoresponder : {
        _internal : {
            ...
            fillAddToListRule : function(cpo, inAction) {
                ...
                if (inParams.language) {
                    ngSettings.Autoresponder._internal.SelectLanguage(cpo, inParams.language);
                }
            },
            ...
            SelectLanguage : function(cpo, languageCode) {
                ...
                if (cpo.$scope.main.languages) {
                    ...
                    setTimeout(function() {
                        ngSettings.Autoresponder._internal.SelectLanguage(cpo, languageCode);
                    }, 200);
                }
            }
        },
        ...
        Events : {
            ...
            Save_onClick : function(cpo) {
                ...
                cpo.AddToListKeywordActionRule.ruleParams = {
                    ...
                    language : cpo.SelectedLanguage.languageCode
                };
        ...
        Controller : function($scope, $http, $cookieStore) {
            ...
            cpo.SelectedLanguage = arCtrl.Languages[0];
