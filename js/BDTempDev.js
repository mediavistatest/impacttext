...
var ngSettings = {
    ...
    Autoresponder : {
        _internal : {
            ...
            fillAddToListRule : function(rule, inAction) {
                //rule = inAction;
                rule.checked = (inAction.status == 'A');
                rule.autoResponderKeywordActionID = inAction.autoResponderKeywordActionID;
                ...
                if (inParams.message) {
                    rule.contactListId = inParams.contactlistid;
                }
            }
        },
        ServerRequests : {
                    ...
                    if (result.apidata.length > 0) {
                        for (var i = 0; i < result.apidata.length; i++) {
                            ...
                            case 'mvDelay2':
                                ...
                                break;
                            case 'mvAddToList':
                                ngSettings.Autoresponder._internal.fillAddToListRule(cpo.keyworAddToListKeywordActionRule, result.apidata[i]);
                                break;
                            default:
                                break;
                            }
