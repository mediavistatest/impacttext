        ...
        Methods : {
            ...
            GetLocalDateTimeString : function(utcDateTime) {
                if (utcDateTime) {
                    ...
                    while (dateStr.indexOf('/')>-1){
                        if (resDate){
                            resDate = resDate + '-'+ ("0" + dateStr.substring(0, dateStr.indexOf('/'))).slice(-2);
                        }
                        else {
                             resDate = ("0" + dateStr.substring(0, dateStr.indexOf('/'))).slice(0, dateStr.indexOf('/')+1);
                        }
                    ...
                    // console.log(resDate + ' ' + ("0" + date.getHours()).slice(-2) + ':' + ("0" + date.getMinutes()).slice(-2) + ':' + ("0" + date.getSeconds()).slice(-2))
            ...
            SetPagingDataSliced : function($scope, data, totalResultsCount) {
                ...
                for (var i = 0; i < data.length; i++) {
                    console.log(data[i].messageDate)
                    console.log(data[i])
                    data[i].createdDate = data[i].createdDate ? ngInbox._internal.Methods.GetLocalDateTimeString(data[i].createdDate + ' UTC') : null;
                    data[i].messageDate = data[i].messageDate ? ngInbox._internal.Methods.GetLocalDateTimeString(data[i].messageDate + ' UTC') : null;
                    data[i].sendEndDate = data[i].sendEndDate ? ngInbox._internal.Methods.GetLocalDateTimeString(data[i].sendEndDate + ' UTC') : null;
                    data[i].updatedDate = data[i].updatedDate ? ngInbox._internal.Methods.GetLocalDateTimeString(data[i].updatedDate + ' UTC') : null;
                ...
                // console.log(data)
                //
                // console.log(data[0].createdDate + ' UTC')
                //
                // var date = new Date(data[0].createdDate + ' UTC');
